...
- **Night cumulative cap:** across the whole night window (22:00–08:00), total newly placed buy notional ≤ RiskLimit.transaction_day_limit (24h; $600 reduce / $1000 normal). Track prior night Book runs (22/00/04); if cumulative would exceed, skip and report.

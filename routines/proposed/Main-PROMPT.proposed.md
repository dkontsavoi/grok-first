# Main (PROPOSED — not live)

> **Status:** Proposed for Dzmitry review. Live routine still uses `routines/Main-PROMPT.md`. Do not point JSON/schedulers here until approved.
...
- **Night cumulative cap (NEW):** across the whole night window (22:00–08:00), total newly placed buy notional ≤ **$1500–2000 USD**. Track prior night Main runs (22/00/04); if cumulative would exceed, skip and report.

# Tactical (PROPOSED — not live)

> **Status:** Proposed for Dzmitry review. Live routine still uses `routines/Tactical-PROMPT.md`. Do not adopt until approved.
...
2. Same trading rules as Main (proposed): long-only, buy-the-dip / sell-in-strength, restricted list `BTC ETH ARB HYPE PUMP ENA SKY JUP AAVE AERO LDO UNI RAY POL SYRUP ZRO ICP DASH LINK CRV MORPHO SUI ZEN NEAR SOL VVV`.
